...
public class Player extends MapObject {
	...
	public Player(TileMap tm) {
		...
		AudioPlayer.load("/Audio/jump.wav", "jump");
        AudioPlayer.load("/Audio/falling.wav", "falling");
        AudioPlayer.load("/Audio/hit1.wav", "hit1");
        AudioPlayer.load("/Audio/bonus.wav", "bonus");
